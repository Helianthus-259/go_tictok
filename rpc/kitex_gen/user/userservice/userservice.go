...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"TokenVerify":             kitex.NewMethodInfo(tokenVerifyHandler, newUserServiceTokenVerifyArgs, newUserServiceTokenVerifyResult, false),
...
func tokenVerifyHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*user.UserServiceTokenVerifyArgs)
	realResult := result.(*user.UserServiceTokenVerifyResult)
	success, err := handler.(user.UserService).TokenVerify(ctx, realArg.Request)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newUserServiceTokenVerifyArgs() interface{} {
	return user.NewUserServiceTokenVerifyArgs()
}

func newUserServiceTokenVerifyResult() interface{} {
	return user.NewUserServiceTokenVerifyResult()
}
...
func (p *kClient) TokenVerify(ctx context.Context, request *user.TokenVerifyRequest) (r *user.TokenVerifyResponse, err error) {
	var _args user.UserServiceTokenVerifyArgs
	_args.Request = request
	var _result user.UserServiceTokenVerifyResult
