...
type Client interface {
	...
	IsFavoriteVideos(ctx context.Context, request *favorite.IsFavoriteVideosRequest, callOptions ...callopt.Option) (r *favorite.IsFavoriteVideosResponse, err error)
}
...
func (p *kFavoriteServiceClient) FavoriteList(ctx context.Context, request *favorite.FavoriteListRequest, callOptions ...callopt.Option) (r *favorite.FavoriteListResponse, err error) {
...
func (p *kFavoriteServiceClient) IsFavoriteVideos(ctx context.Context, request *favorite.IsFavoriteVideosRequest, callOptions ...callopt.Option) (r *favorite.IsFavoriteVideosResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.IsFavoriteVideos(ctx, request)
}
