...
struct FollowActionRequest {
    ...
    2: i32 action_type, // 1-关注，2-取消关注
    3: i64 my_user_id // 当前用户id
}
...
struct IsFollowTargetRequest {
    1: i64 user_id, // 用户id
    2: i64 target_id // 用户id
}

struct IsFollowTargetResponse {
    1: BaseResp base_resp
    2: bool exist
}

struct IsFollowManyTargetsRequest {
    1: i64 user_id, // 用户id
    2: list<i64> target_ids // 用户id
}

struct IsFollowManyTargetsResponse {
    1: BaseResp base_resp
    2: list<bool> many_exist
}
...
service RelationService {
    FollowActionResponse FollowAction(1: FollowActionRequest request),
    FollowListResponse FollowList(1: FollowListRequest request),
    FansListResponse FansList(1: FansListRequest request),
    FriendListResponse FriendList(1: FriendListRequest request),
    IsFollowTargetResponse IsFollowTarget(1: IsFollowTargetRequest request),
    IsFollowManyTargetsResponse IsFollowManyTargets(1: IsFollowManyTargetsRequest request),
