...
require (
	...
	github.com/hertz-contrib/obs-opentelemetry/logging/zap v0.0.0-20230924135802-fef07fa67e74 // indirect
	github.com/hertz-contrib/obs-opentelemetry/tracing v0.3.0 // indirect
