...
func AddUserCount(ctx context.Context, userCount *model.UserCount) (err error) {
...
func GetUserCountInfoByUserId(ctx context.Context, userId int64) (userCount *model.UserCount, err error) {
...
func AddFollowCountByUserId(ctx context.Context, userId int64) (err error) {
...
func AddFollowerCountByUserId(ctx context.Context, userId int64) (err error) {
...
func SubFollowCountByUserId(ctx context.Context, userId int64) (err error) {
	result := DB.WithContext(ctx).Table("user_count").Where("user_id=?", userId).Update("follow_count", gorm.Expr("follow_count- ?", 1))
	err = result.Error
	return
}
...
func SubFollowerCountByUserId(ctx context.Context, userId int64) (err error) {
	result := DB.WithContext(ctx).Table("user_count").Where("user_id=?", userId).Update("follower_count", gorm.Expr("follower_count- ?", 1))
	err = result.Error
	return
}
...
func AddWorkCountByUserId(ctx context.Context, userId int64) (err error) {
...
func AddFavoriteCountByUserId(ctx context.Context, userId int64) (err error) {
...
func AddTotalFavoriteCountByUserId(ctx context.Context, userId int64) (err error) {
...
func SubFavoriteCountByUserId(ctx context.Context, userId int64) (err error) {
	result := DB.WithContext(ctx).Table("user_count").Where("user_id=?", userId).Update("favorite_count", gorm.Expr("favorite_count- ?", 1))
	err = result.Error
	return
}
...
func SubTotalFavoriteCountByUserId(ctx context.Context, userId int64) (err error) {
	result := DB.WithContext(ctx).Table("user_count").Where("user_id=?", userId).Update("total_favorited", gorm.Expr("total_favorited- ?", 1))
	err = result.Error
	return
}
